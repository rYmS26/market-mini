...
<div class="page-header">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <img src="{{ asset('storage/photos/men-shopping.png') }}" alt="Our Mission" class="img-fluid rounded no-shadow">
            </div>
    ...
    <button class="btn mb-4" style="background-color: #179BAE; border-radius: 25px;">
...
.page-header {
  background: linear-gradient(
    rgba(0, 0, 0, 0.5), /* Warna hitam dengan transparansi 50% */
    rgba(0, 0, 0, 0.5) /* Warna hitam dengan transparansi 50% */
